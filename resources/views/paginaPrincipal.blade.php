        ...
        <nav class="sticky-top">
          <div>
              <ul class="menu text-center">
                <li class="active"><a href="paginaPrincipal">Principal</a></li><li><a href="preguntas">Preguntas</a></li><li><a href="registro">Registrarse</a></li><li><a href="ingresar">Ingresar</a></li>
              </ul>
          </div>
        </nav>
    <main>
